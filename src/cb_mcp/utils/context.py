...
class AppContext:
    ...
    Attributes:
        ...
        read_only_mode: When True, all write operations (KV, Query,
            scope/collection management, and index management) are disabled
            and KV, collection management, and index write tools are not loaded.
